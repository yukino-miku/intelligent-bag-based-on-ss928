...
class SessionRecorderTest(unittest.TestCase):
    ...
    def test_session_files_have_required_headers_and_summary_percentiles(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(200.0, summary["capture_only_p50_blind_ms"])
            self.assertEqual(200.0, summary["capture_only_p95_blind_ms"])
            self.assertEqual(200.0, summary["capture_only_p99_blind_ms"])
            ...
            self.assertEqual(1200.0, summary["end_to_end_left_p50_gap_ms"])
            self.assertIsNone(summary["end_to_end_right_p50_gap_ms"])
