...
生成 `smartbag-ss928-v1.0.0-rc1.tar.gz` 和 `SHA256SUMS`。包内包含完整 Git 源码、AArch64 runner、systemd、配置、profile、音频和安装器，不包含厂商 SDK、ACL runtime、secret 或当前许可证受阻的 YOLO11n OM。
